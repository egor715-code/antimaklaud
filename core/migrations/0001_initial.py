# Generated by Django 5.2.1 on 2025-06-01 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chevron', models.ImageField(blank=True, null=True, upload_to='team_chevrons/')),
                ('description', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('ORGANIZER', 'Organizer'), ('MEMBER', 'Member')], default='MEMBER', max_length=50)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
                ('chevron_photo', models.ImageField(blank=True, null=True, upload_to='chevrons/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.banreason')),
